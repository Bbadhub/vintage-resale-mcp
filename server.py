"""
vintage-resale-mcp - MCP Server (Protocol 2024-11-05)
...
Usage:
    python server.py              # SSE on port 8100
...
logger = logging.getLogger("vintage-resale-mcp")
...
def main():
    parser = argparse.ArgumentParser(description="vintage-resale-mcp MCP Server")
    ...
    parser.add_argument("--port", type=int, default=None, help="SSE server port (default: 8100)")
